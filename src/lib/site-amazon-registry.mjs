...
export const BOTTOM_STRIP_HEADING = "Pantry staples worth buying in bulk";
export const BOTTOM_STRIP_SUBHEAD = "Household staples we track on KitchenWise — partner links, no extra cost to you.";
